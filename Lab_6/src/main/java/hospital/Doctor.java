...
public class Doctor extends Human implements Comparable<Doctor> {
    ...
    public Doctor(Builder builder) {
        ...
        hospitalNumber = builder.hospitalNumber;
    }
    ...
    public void setHospitalNumber(int hospitalNumber) throws IllegalArgumentException {
        if (hospitalNumber < 0)
    ...
    public static class Builder extends Human.Builder {
        ...
        private int salary;
        @Positive(message = "Hospital number must be greater than zero")
        private int hospitalNumber;
         ...
         * @return Builder instance
         */
        public Builder setPatients(List<Patient> patients) throws IllegalArgumentException {
            for (Patient patient : patients)
                if (patient.getDoctorId() != id)
                    throw new IllegalArgumentException("Patient " + patient.getName() + " " +
                            patient.getSurname() + " not attach to doctor");
            this.patients.addAll(patients);
            return this;
        }
        ...
        public Builder setHospitalNumber(int hospitalNumber) throws IllegalArgumentException {
            if (hospitalNumber < 0)
                throw new IllegalArgumentException("Wrong hospital number");
            this.hospitalNumber = hospitalNumber;
            return this;
        }
