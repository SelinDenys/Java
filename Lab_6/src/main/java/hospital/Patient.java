...
public class Patient extends Human implements Comparable<Patient> {
    ...
    public void setDoctorId(int doctorId) throws IllegalArgumentException {
        if (medicalCardId < 0)
    ...
    public static class Builder extends Human.Builder {
        ...
        public Builder setDoctorId(int doctorId) throws IllegalArgumentException {
            if (doctorId < 0)
                throw new IllegalArgumentException("Wrong doctor id");
            this.doctorId = doctorId;
            return this;
        }
